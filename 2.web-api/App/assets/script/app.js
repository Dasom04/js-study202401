...
// 입력창에 입력한 숫자를 읽는 함수.
const getUserNumberInput = () => parseInt($userInput.value);  // 앞에 + 붙이는것과 같은 함수 (숫자로 바꾸는 법)
...
const calculate = type => {
  ...
  $currnetCalculationOutput.textContent = `${originalResult} ${mark} ${enteredNumber}`;
  $currentReserltOutput.textContent = currentResult;
